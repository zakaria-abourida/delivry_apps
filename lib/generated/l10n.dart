...
class S {
  ...
  /// `Cuisine refreshed successfully`
  String get cuisine_refreshed_successfuly {
    return Intl.message(
      'Cuisine refreshed successfully',
      name: 'cuisine_refreshed_successfuly',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Tell us about the delivery man`
  String get tell_us_about_the_delivery_man {
    return Intl.message(
      'Tell us about the delivery man',
      name: 'tell_us_about_the_delivery_man',
      desc: '',
      args: [],
    );
  }
  ...
  /// `How would you rate the delivery man ?`
  String get how_would_you_rate_the_delivery_man {
    return Intl.message(
      'How would you rate the delivery man ?',
      name: 'how_would_you_rate_the_delivery_man',
      desc: '',
      args: [],
    );
  }
