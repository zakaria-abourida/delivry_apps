...
class ChatMessageListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return currentUser.value.id == this.chat.sender_id  ? getSentMessageLayout(context) : getReceivedMessageLayout(context);
  }
          ...
          children: [
            new Flexible(
              child: new Column(
                ...
                children: <Widget>[
                  new Text(this.chat.sender.name, style: Theme.of(context).textTheme.bodyText1.merge(TextStyle(fontWeight: FontWeight.w600))),
                  new Container(
            ...
            new Container(
              ...
              child: ClipRRect(
                ...
                child: CachedNetworkImage(
                  ...
                  fit: BoxFit.cover,
                  imageUrl: this.chat.sender.image.thumb,
          ...
          children: <Widget>[
            ...
            new Flexible(
              child: new Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  new Text(this.chat.sender.name,
