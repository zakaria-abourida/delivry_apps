...
class DeliveryAddressesItemWidget extends StatelessWidget {
  ...
  DeliveryAddressesItemWidget({Key key, this.address, this.onPressed, this.onRightPress, this.onDismissed, this.paymentMethod, this.selected}) : super(key: key);
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        color:
                            (paymentMethod?.selected ?? false) || (selected == true || address?.isDefault == true) ? Theme.of(context).accentColor : Theme.of(context).focusColor),
                    child: Icon(
                      (paymentMethod?.selected ?? false) || (selected == true || address?.isDefault == true) ? Icons.check : Icons.place,
