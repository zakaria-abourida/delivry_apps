...
class Setting {
  ...
  String priceByKm;
  String coursierStartTime;
  String coursierEndTime;
  String coursierDistanceMin;
  String coursierDistanceMax;
  ...
  Setting.fromJSON(Map<String, dynamic> jsonMap) {
    try {
      ...
      priceByKm = jsonMap['price_by_km'] ?? null;
      coursierStartTime = jsonMap['coursier_start_time'] ?? null;
      coursierEndTime = jsonMap['coursier_end_time'] ?? null;
      coursierDistanceMin = jsonMap['coursier_distance_min'] ?? null;
      coursierDistanceMax = jsonMap['coursier_distance_max'] ?? null;
    } catch (e) {
