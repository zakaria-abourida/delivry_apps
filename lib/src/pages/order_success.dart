...
class _OrderSuccessWidgetState extends StateMVC<OrderSuccessWidget> {
  ...
  void initState() {
    ...
    _con.payment = new Payment(widget.routeArgument.id);
    if (widget.routeArgument.param != null)
      _con.zoningFields = widget.routeArgument.param as ZoningFields;
    _con.listenForCarts(
        message:
            "Une erreur s'est produite lors de la tentative de passer une commande");
    super.initState();
  }
                            ...
                            children: <Widget>[
                              ...
                              Row(
                                children: <Widget>[
                                  ...
                                  Helper.getPrice(_con.total.value, context,
                                      style:
                                          Theme.of(context).textTheme.headline6)
                                ],
                              ),
