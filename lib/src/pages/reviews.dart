                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              SizedBox(height: 10),
                              _con.restaurantReview.rate != null && int.parse(_con.restaurantReview.rate) >= 1
                              ? Text('')
                              : FlatButton.icon(
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            mainAxisSize: MainAxisSize.max,
                            children: <Widget>[
                              Text(S.of(context).how_would_you_rate_the_delivery_man,
                                  textAlign: TextAlign.center, style: Theme.of(context).textTheme.subtitle1),
                              SizedBox(height: 10),
                              Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: List.generate(5, (index) {
                                  return InkWell(
                                    onTap: () {
                                      setState(() {
                                        _con.deliveryManReview.rate = (index + 1).toString();
                                      });
                                    },
                                    child: index < int.parse(_con.deliveryManReview.rate)
                                        ? Icon(Icons.star, size: 40, color: Color(0xFFFFB24D))
                                        : Icon(Icons.star_border, size: 40, color: Color(0xFFFFB24D)),
                                  );
                                }),
                              ...
                              TextField(
                                onChanged: (text) {
                                  _con.deliveryManReview.review = text;
                                },
                                maxLines: 2,
                                textAlign: TextAlign.center,
                                decoration: InputDecoration(
                                  contentPadding: EdgeInsets.all(12),
                                  hintText: S.of(context).tell_us_about_the_delivery_man,
                                  hintStyle: Theme.of(context).textTheme.caption.merge(TextStyle(fontSize: 14)),
                                  border: OutlineInputBorder(borderSide: BorderSide(color: Theme.of(context).focusColor.withOpacity(0.1))),
                                  focusedBorder: OutlineInputBorder(borderSide: BorderSide(color: Theme.of(context).focusColor.withOpacity(0.2))),
                                  enabledBorder: OutlineInputBorder(borderSide: BorderSide(color: Theme.of(context).focusColor.withOpacity(0.1))),
                              ...
                              SizedBox(height: 10),
                              _con.deliveryManReview.rate != null && int.parse(_con.deliveryManReview.rate) >= 1
                              ? Text('')                              
                              : FlatButton.icon(
                                padding: EdgeInsets.symmetric(vertical: 10, horizontal: 18),
                                onPressed: () {
                                  _con.addDeliveryManReview(_con.deliveryManReview);
                                  FocusScope.of(context).unfocus();
                                },
                                shape: StadiumBorder(),
                                label: Text(
                        ...
                        // Column(
                        //   children: List.generate(_con.foodsOfOrder.length /*1*/, (index) {
                        //     return Container(
                        //       width: MediaQuery.of(context).size.width,
                        //       margin: EdgeInsets.symmetric(vertical: 20, horizontal: 20),
                        //       padding: EdgeInsets.symmetric(vertical: 30, horizontal: 20),
                        ...
                        //         children: <Widget>[
                        //           Text(
                        //             _con.foodsOfOrder[index].name,
                        //             //"Comment évalueriez-vous ce livreur?", 
                        //             textAlign: TextAlign.center, style: Theme.of(context).textTheme.subtitle1),
                        //           SizedBox(height: 10),
                        //           Row(
                        //             mainAxisAlignment: MainAxisAlignment.center,
                        ...
                        //             decoration: InputDecoration(
                        //               contentPadding: EdgeInsets.all(12),
                        //               hintText: /*S.of(context).tell_us_about_this_food*/ "Parlez-nous de ce livreur",
                        //               hintStyle: Theme.of(context).textTheme.caption.merge(TextStyle(fontSize: 14)),
                        //               border: OutlineInputBorder(borderSide: BorderSide(color: Theme.of(context).focusColor.withOpacity(0.1))),
                        //               focusedBorder: OutlineInputBorder(borderSide: BorderSide(color: Theme.of(context).focusColor.withOpacity(0.2))),
                        //               enabledBorder: OutlineInputBorder(borderSide: BorderSide(color: Theme.of(context).focusColor.withOpacity(0.1))),
