...
class CourierOrderTracking extends StatefulWidget {
  final RouteArgument routeArgument;

  CourierOrderTracking({Key key, this.routeArgument}) : super(key: key);

  @override
  _CourierTrackingWidgetState createState() => _CourierTrackingWidgetState();
}

class _CourierTrackingWidgetState extends StateMVC<CourierOrderTracking>
    with SingleTickerProviderStateMixin, AutomaticKeepAliveClientMixin {
  CourierTrackingController _con;
  TabController _tabController;
  int _tabIndex = 0;
  String _mapStyle;

  _CourierTrackingWidgetState() : super(CourierTrackingController()) {
    _con = controller;
  }
  ...
  void initState() {
    ...
    super.initState();
    changeMapMode();
    final courierOrder = widget.routeArgument.param as CourierOrder;
    _con.listenForOrder(courierOrder);
  }
  ...
  setOrdersStatusText() {
    if (_con.currentOrderStatus.id == "1")
      return Text(
  ...
  setOrderStatus() {
    if (_con.isDriverArrived)
      return Image.asset(
        "assets/img/4-abracadabra.jpg",
        fit: BoxFit.fitWidth,
      );
    switch (_con.currentOrderStatus.id) {
      case "1":
        return Image.asset(
          "assets/img/cmdt.png",
          fit: BoxFit.fitWidth,
      ...
      case "4":
        return Image.asset(
          "assets/img/2-abracadabra.jpg",
          fit: BoxFit.fitWidth,
        );
        break;
      case "5":
        return Image.asset(
          "assets/img/3-abracadabra.jpg",
          fit: BoxFit.fitWidth,
        );
        break;
      case "6":
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      FlatButton(
                        ...
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: Helper.getStarsList(5, size: 35),
                        ),
                      ),
                    ],
                  ))
