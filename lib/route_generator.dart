...
import 'src/pages/courier/courier_order.dart';
import 'src/pages/courier/courier_order_success.dart';
import 'src/pages/courier/courier_order_tracking.dart';
import 'src/pages/courier/courier_reviews.dart';
import 'src/pages/cuisine.dart';
...
import 'src/pages/geolocation_screen.dart';
...
import 'src/pages/restaurant_list.dart';
...
class RouteGenerator {
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case '/Geolocation':
        return MaterialPageRoute(builder: (_) => GeolocationScreen());
      case '/Preauth':
        return MaterialPageRoute(builder: (_) => PreAuthScreen());
      case '/Login':
      ...
      case '/Restaurants':
        return MaterialPageRoute(builder: (_) => RestaurantListWidget());
      ...
      case '/Cuisine':
        return MaterialPageRoute(
            builder: (_) =>
                CuisineWidget(routeArgument: args as RouteArgument));
      case '/Cart':
        return MaterialPageRoute(
      ...
      case '/PayOnPickup':
        return MaterialPageRoute(
            builder: (_) => OrderSuccessWidget(
                routeArgument: RouteArgument(id: 'Pay on Pickup')));
      case '/PayPal':
        return MaterialPageRoute(
            builder: (_) =>
      ...
      case '/CourierOrder':
        return MaterialPageRoute(builder: (_) => CourierOrderScreen());
      case '/CourierOrderSuccess':
        return MaterialPageRoute(
            builder: (_) =>
                CourierOrderSuccess(routeArgument: args as RouteArgument));
      case '/CourierTrackingOrder':
        return MaterialPageRoute(
            builder: (_) =>
                CourierOrderTracking(routeArgument: args as RouteArgument));
      case '/CourierReviews':
        return MaterialPageRoute(
            builder: (_) =>
                CourierReviews(routeArgument: args as RouteArgument));
      default:
